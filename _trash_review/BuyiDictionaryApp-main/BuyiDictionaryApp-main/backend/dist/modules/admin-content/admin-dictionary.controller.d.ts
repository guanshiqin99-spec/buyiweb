...
export declare class AdminDictionaryController {
    ...
    create(payload: DictionaryAdminDto): Promise<import("../../entities/dictionary-entry.entity").DictionaryEntry>;
    ...
    update(id: number, payload: UpdateDictionaryAdminDto): Promise<import("../../entities/dictionary-entry.entity").DictionaryEntry>;
