...
import imgBg from '@/assets/images/bouyei-landscape.jpg'
...
<template>
  <div class="login-page">
    ...
    <div class="login-card liquid-glass glow-card">
      ...
      <form class="login-form" @submit.prevent="handleSubmit">
        ...
        <p v-if="errorMsg" class="form-error" role="alert" tabindex="-1">{{ errorMsg }}</p>
...
.form-field input {
  height: 44px;
  padding: 0 16px;
  border: 1px solid var(--c-white-35);
  border-radius: 12px;
