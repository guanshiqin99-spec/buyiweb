...
export declare class AdminSongsController {
    ...
    create(payload: SongAdminDto): Promise<import("../../entities/song.entity").Song>;
    ...
    update(id: number, payload: UpdateSongAdminDto): Promise<import("../../entities/song.entity").Song>;
